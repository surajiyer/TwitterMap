...
public class GoogleTranslation {
    ...
    /**
     * Translate inputted text to given language code, using google GoogleTranslation.
     ...
     * @return 
     * @throws java.lang.Exception if it cannot reach the google GoogleTranslation server.
     */
    ...
    /**
     * Return an array of translated versions of the given text based on given
     * language codes.
     * 
     * @param to_translate text to be translated
     * @param languages array of language codes
     * @return an array of translated versions of given text in the order of the
     * given language codes.
     * @throws java.lang.Exception if it cannot reach the google GoogleTranslation server.
     */
    public static String[] translate(String to_translate, String... languages) throws Exception {
        String[] translated = new String[language_codes.length];
        for(int i=0; i<languages.length; i++) {
            translated[i] = translate(to_translate, "auto", languages[i]);
        }
        return translated;
    }
